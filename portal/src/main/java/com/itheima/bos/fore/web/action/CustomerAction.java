...
public class CustomerAction extends ActionSupport implements ModelDriven<Customer> {
    ...
    public String regist() {
        ...
        if (StringUtils.isNotEmpty(checkcode) && StringUtils.isNotEmpty(serverCode)
            ...
            // 注册
            WebClient.create("http://localhost:8088/crm/webService/customerService/save")
            ...
            String emailBody =
                    "感谢您注册本网站的帐号，请在24小时之内点击<a href='http://localhost:8280/portal/customerAction_active.action?activeCode="
                            + activeCode + "&telephone=" + model.getTelephone() + "'>本链接</a>激活您的帐号";
    ...
    public String login() {
        ...
        if (StringUtils.isNotEmpty(serverCode) && StringUtils.isNotEmpty(checkcode)
            ...
            Customer customer = WebClient
                    .create("http://localhost:8088/crm/webService/customerService/isActived")
                    .type(MediaType.APPLICATION_JSON).query("telephone", model.getTelephone())
            ...
            if (customer != null && customer.getType() != null) {
                if (customer.getType() == 1) {
                    ...
                    Customer c = WebClient
                            .create("http://localhost:8088/crm/webService/customerService/login")
